<template>
    <div class="container flex-sub mt20">
        <div class="border-line">
            <GreyTopTitle title="Coupon Management - Distribute coupons" types="required"></GreyTopTitle>
                ...
                <div>
                    <el-form :model="queryParams" ref="queryForm" :inline="true">
                        <el-form-item label="Coupon Name" prop="menuName">
                            <el-input v-model="queryParams.menuName" placeholder="Coupon Name" clearable size="small"
                        ...
                        <el-form-item label="Status" prop="status">
                            <el-select v-model="queryParams.status" placeholder="Status" clearable size="small"
                                style="width: 120px">
                                <el-option v-for="dict in dictOption" :key="dict.value" :label="dict.label"
                                    :value="dict.value" />
                            </el-select>
                        </el-form-item>
                        <el-form-item label="Creation Time">
                            <el-date-picker v-model="value1" type="date" placeholder="Year/Month/Day">
                            </el-date-picker>
                        </el-form-item>
                        <el-form-item>
                    ...
                    <el-table v-loading="loading" :data="menuList" row-key="menuId">
                        <el-table-column prop="menuName" align="center" label="Coupon ID" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="icon" label="Coupon Name" align="center" :show-overflow-tooltip="true">
                        </el-table-column>
                        <el-table-column prop="orderNum" label="Coupon Ink" :show-overflow-tooltip="true"
                            align="center"></el-table-column>
                        <el-table-column prop="perms" label="Applied courses" :show-overflow-tooltip="true"
                            align="center"></el-table-column>
                        <el-table-column prop="component" label="Distributed Users" :show-overflow-tooltip="true"
                            align="center"></el-table-column>
                        <el-table-column prop="component" label="Expiration Date" :show-overflow-tooltip="true"
                            align="center"></el-table-column>
            ...
            <template slot-scope="scope">
              <span>{{ parseTime(scope.row.createTime) }}</span>
                    ...
                    <pagination v-show="total > 0" :total="total" :page.sync="queryParams.pageNum"
                        :limit.sync="queryParams.pageSize" @pagination="getList" layout=" prev, pager, next,sizes,jumper" />
                </div>
            </template>
...
export default {
    components: { GreyTopTitle, AddCoupon },
    data() {
        return {
            // 查询参数
            queryParams: {
