    ...
    <div class="login">
      <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form">
        ...
        <div class="register acknowledge" v-if="register">
          Click “Log In” to agree to Mespery’s <router-link class="link-type" :to="'/register'"> <span> Terms of Service </span></router-link>
          and acknowledge that Mespery’s<router-link class="link-type" :to="'/register'"> <span> Privacy Policy </span></router-link>applies to you.
          </div>
      </el-form>
      <!--  底部  -->
